<?php 
    ...
    //fetch all users we have except current logged in user
    $current_admin_id = $_SESSION['user-id'];
    $query = "SELECT id, firstname, lastname, username, is_admin FROM users WHERE NOT id=$current_admin_id LIMIT 10";
